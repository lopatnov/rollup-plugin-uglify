(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('terser'), require('path')) :
	typeof define === 'function' && define.amd ? define(['terser', 'path'], factory) :
	...
	constants.CHAR_0;
	constants.CHAR_9;
	constants.CHAR_UPPERCASE_A;
	constants.CHAR_LOWERCASE_A;
	constants.CHAR_UPPERCASE_Z;
	constants.CHAR_LOWERCASE_Z;
	...
	constants.CHAR_CARRIAGE_RETURN;
	constants.CHAR_CIRCUMFLEX_ACCENT;
	constants.CHAR_COLON;
	constants.CHAR_COMMA;
	constants.CHAR_DOT;
	constants.CHAR_DOUBLE_QUOTE;
	constants.CHAR_EQUAL;
	constants.CHAR_EXCLAMATION_MARK;
	constants.CHAR_FORM_FEED;
	constants.CHAR_FORWARD_SLASH;
	constants.CHAR_GRAVE_ACCENT;
	constants.CHAR_HASH;
	constants.CHAR_HYPHEN_MINUS;
	constants.CHAR_LEFT_ANGLE_BRACKET;
	constants.CHAR_LEFT_CURLY_BRACE;
	constants.CHAR_LEFT_SQUARE_BRACKET;
	constants.CHAR_LINE_FEED;
	constants.CHAR_NO_BREAK_SPACE;
	constants.CHAR_PERCENT;
	constants.CHAR_PLUS;
	constants.CHAR_QUESTION_MARK;
	constants.CHAR_RIGHT_ANGLE_BRACKET;
	constants.CHAR_RIGHT_CURLY_BRACE;
	constants.CHAR_RIGHT_SQUARE_BRACKET;
	constants.CHAR_SEMICOLON;
	constants.CHAR_SINGLE_QUOTE;
	constants.CHAR_SPACE;
	constants.CHAR_TAB;
	constants.CHAR_UNDERSCORE;
	constants.CHAR_VERTICAL_LINE;
	constants.CHAR_ZERO_WIDTH_NOBREAK_SPACE;
	constants.SEP;
	constants.extglobChars;
	constants.globChars;
	...
	utils.isRegexChar;
	utils.escapeRegex;
	utils.toPosixSlashes;
	utils.removeBackslashes;
	utils.supportsLookbehinds;
	utils.isWindows;
	utils.escapeLast;
	utils.removePrefix;
	utils.wrapOutput;
